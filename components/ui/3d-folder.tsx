    ...
    >
      ...
      >
        <button
          ...
          className={cn(
            "w-12 h-12 flex items-center justify-center rounded-full bg-muted/80 border border-white/10 shadow-2xl text-foreground hover:bg-muted transition-colors duration-300",
          )}
        >
      ...
      <div
        className="absolute left-4 md:left-10 z-50"
        style={{
      ...
      >
        <button
          ...
          className={cn(
            "w-14 h-14 flex items-center justify-center rounded-full bg-muted/80 border border-white/10 text-foreground hover:scale-110 active:scale-95 transition-transform duration-300 disabled:opacity-0 shadow-2xl",
          )}
        >
      ...
      <div
        className="absolute right-4 md:right-10 z-50"
        style={{
        ...
        <div className={cn("relative overflow-hidden rounded-[inherit] bg-card border border-white/10 shadow-[0_35px_60px_-15px_rgba(0,0,0,0.5)]")}>
          ...
          >
            <div className="flex items-center justify-between gap-6">
              ...
              <button 
                onClick={() => currentProject?.onClick?.()}
                data-magnetic
...
export const AnimatedFolder: React.FC<AnimatedFolderProps> = ({ title, subtitle, projects, className, gradient }) => {
  ...
  const backBg = gradient || "#FFFFFF";
  const tabBg = gradient || "#FFFFFF";
  const frontBg = gradient || "#FFFFFF";
  ...
  return (
    <>
      <div className="w-full h-full flex justify-center">
        <motion.div
          className={cn("relative flex flex-col items-center justify-center p-8 rounded-2xl cursor-pointer transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] group", className)}
        ...
        >
          ...
          <div className="mt-6 text-center z-40 relative">
            <h3 className="text-xl font-bold text-foreground tracking-tight transition-colors duration-300 group-hover:text-primary">
              {title}
            </h3>
          </div>
        </motion.div>
